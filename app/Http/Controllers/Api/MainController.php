...
{    public function getPosts()
    ...
    public function latestPosts($query)
    {
        ...
        if (!$latest_posts) {
            return $this->apiResponse(404, 'Posts Not Found');
        }
        return $latest_posts;
    }
    ...
    public function categoryWithPosts()
    {
        ...
        if (!$categories) {
            return $this->apiResponse(404, 'Categories Not Found');
        }
    ...
    public function showPost($slug)
    {
        ...
        return $this->apiResponse(200, 'this is posts', new PostResource($post));
    }
    ...
    public function getPostComments($slug)
    {
        ...
        if (!$comments) {
            return $this->apiResponse(404, 'Comments Not Found');
        }
        return $this->apiResponse(200, 'This Post Comments', new CommentCollection($comments));
    }
