...
<aside class="col-md-3 nav-sticky dashboard-sidebar">
    ...
    <div class="list-group profile-sidebar-menu">
        ...
        <a href="{{ route('frontend.dashboard.notifications.index') }}"
           class="list-group-item {{ $notify_active ?? '' }}  list-group-item-action menu-item"
           data-section="notifications">
            <i class="fas fa-bell"></i> Notification
        </a>
        <a href="{{ route('frontend.dashboard.setting') }}"
           class="list-group-item list-group-item-action {{ $setting_active ?? '' }}  menu-item"
           data-section="settings">
            <i class="fas fa-cog"></i> Settings
        </a>
        <a href="{{ $setting->whatsapp }}" class="list-group-item list-group-item-action   menu-item"
           data-section="settings">
